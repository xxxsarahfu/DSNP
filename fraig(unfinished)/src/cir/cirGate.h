...
{
public:
   CirGate(unsigned gid = 0, unsigned lineNo = 0): gateid(gid), lineNum(lineNo), name(""){
  ...
  //my for sweep
  //bool bTraced;
  //void setTracedOrNot(bool traced) {bTraced = traced;}
  //bool isTraced()const {return bTraced;}
